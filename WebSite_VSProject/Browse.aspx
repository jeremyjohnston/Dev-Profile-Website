...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p>
        ...
        <asp:Table ID="Table1" runat="server" Height="150px" Width="529px" 
            ...
            <asp:TableRow runat="server">
                <asp:TableCell runat="server"><asp:Image ID="Image4" runat="server" BorderColor="#1892BB" BorderStyle="Solid" ImageUrl="~/Images/project-1.png" /></asp:TableCell>
                <asp:TableCell runat="server"><asp:Image ID="Image5" runat="server" BorderColor="#1892BB" BorderStyle="Solid" ImageUrl="~/Images/project-2.png" /></asp:TableCell>
                <asp:TableCell runat="server"><asp:Image ID="Image6" runat="server" BorderColor="#1892BB" BorderStyle="Solid" ImageUrl="~/Images/project-3.png" /></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </p>
    <p>
